...
The `number of followers` of users in Yemen on `2024/2/14 10:21 AM UTC`. This list contains users from `Yemen` and cities ` Sana'a`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ws-rush">
				<img src="https://avatars.githubusercontent.com/u/37883750?s=72&v=4" width="24" alt="Avatar of ws-rush"> ws-rush
			</a><br/>
			Rushied
		</td>
		<td>No Company</td>
