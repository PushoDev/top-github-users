...
The `number of followers` of users in Slovenia on `2023/12/25 1:52 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
