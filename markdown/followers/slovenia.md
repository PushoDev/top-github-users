...
The `number of followers` of users in Slovenia on `2024/2/8 1:44 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
