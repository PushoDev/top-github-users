...
The `number of followers` of users in Slovenia on `2023/12/16 3:22 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
