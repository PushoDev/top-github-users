...
The `number of followers` of users in Slovenia on `2023/12/7 3:23 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
