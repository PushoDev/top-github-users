...
The `number of followers` of users in Slovenia on `2024/3/5 6:08 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
