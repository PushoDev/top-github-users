...
The `number of followers` of users in Slovenia on `2024/3/2 4:23 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
