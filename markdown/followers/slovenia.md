...
The `number of followers` of users in Slovenia on `2024/2/19 9:20 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
