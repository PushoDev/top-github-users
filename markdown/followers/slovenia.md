...
The `number of followers` of users in Slovenia on `2024/1/12 1:14 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
