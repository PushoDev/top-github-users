...
The `number of followers` of users in Slovenia on `2024/2/22 8:08 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
