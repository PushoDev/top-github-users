...
The `number of followers` of users in Nicaragua on `2023/12/27 1:12 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
