...
The `number of followers` of users in Nicaragua on `2024/1/5 1:15 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
