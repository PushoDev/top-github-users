...
The `number of followers` of users in Nicaragua on `2023/11/27 3:23 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
