...
The `number of followers` of users in Nicaragua on `2023/11/30 3:08 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
