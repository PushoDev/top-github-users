...
The `number of followers` of users in Nicaragua on `2024/2/22 8:24 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
