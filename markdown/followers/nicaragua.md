...
The `number of followers` of users in Nicaragua on `2024/3/2 5:08 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
