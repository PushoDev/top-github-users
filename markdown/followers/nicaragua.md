...
The `number of followers` of users in Nicaragua on `2024/1/14 1:11 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
