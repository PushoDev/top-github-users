...
The `number of followers` of users in Nicaragua on `2024/2/1 3:08 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
