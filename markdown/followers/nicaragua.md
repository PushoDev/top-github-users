...
The `number of followers` of users in Nicaragua on `2024/2/4 2:18 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
