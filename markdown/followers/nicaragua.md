...
The `number of followers` of users in Nicaragua on `2024/2/13 11:07 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
