...
The `number of followers` of users in Ecuador on `2023/11/26 1:11 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
