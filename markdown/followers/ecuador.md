...
The `number of followers` of users in Ecuador on `2023/12/2 12:32 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
