...
The `number of followers` of users in Netherlands on `2024/2/4 1:24 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.
