...
The `number of followers` of users in Chile on `2023/12/20 5:19 AM UTC`. This list contains users from `Chile` and cities `Santiago` `Valparaíso` `Viña-del-mar` `Arica` `Temuco` `Concepcion` `Puerto-montt`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `967 users`  in Chile. You need at least `22 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LeonardoMV94">
				<img src="https://avatars.githubusercontent.com/u/43768317?s=72&u=b06937ccd0e6a404b808888342ee8838d4c96319&v=4" width="24" alt="Avatar of LeonardoMV94"> LeonardoMV94
			</a><br/>
			Leonardo Muñoz
		</td>
		<td>No Company</td>
