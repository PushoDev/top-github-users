...
The `number of followers` of users in Uruguay on `2024/1/15 10:25 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `968 users`  in Uruguay. You need at least `8 followers` to be on this list.
