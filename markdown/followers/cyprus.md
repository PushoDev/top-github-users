...
The `number of followers` of users in Cyprus on `2023/12/29 8:15 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/John_2P">John_2P</a></td>
		<td>Cyprus</td>
		<td>11</td>
	</tr>
	<tr>
