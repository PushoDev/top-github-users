...
The `number of followers` of users in Botswana on `2024/1/9 11:19 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
