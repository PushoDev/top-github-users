...
The `number of followers` of users in Botswana on `2024/3/6 4:08 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
