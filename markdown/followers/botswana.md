...
The `number of followers` of users in Botswana on `2024/2/17 8:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
