...
The `number of followers` of users in Botswana on `2023/11/26 2:32 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
