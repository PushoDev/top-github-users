...
The `number of followers` of users in Botswana on `2024/3/9 2:19 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
