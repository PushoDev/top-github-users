...
The `number of followers` of users in Botswana on `2023/12/25 11:18 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
