...
The `number of followers` of users in Botswana on `2024/2/6 1:05 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
