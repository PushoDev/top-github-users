...
The `number of followers` of users in Mauritania on `2024/1/14 6:19 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
