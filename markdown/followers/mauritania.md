...
The `number of followers` of users in Mauritania on `2024/1/29 8:08 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
