...
The `number of followers` of users in Mauritania on `2024/3/31 7:02 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
