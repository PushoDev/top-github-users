...
The `number of followers` of users in Mauritania on `2023/12/18 8:20 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
