...
The `number of followers` of users in Mauritania on `2024/2/19 3:16 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
