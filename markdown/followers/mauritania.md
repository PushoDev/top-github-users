...
The `number of followers` of users in Mauritania on `2024/2/22 2:13 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
