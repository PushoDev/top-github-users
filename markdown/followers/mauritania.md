...
The `number of followers` of users in Mauritania on `2024/2/27 11:13 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
