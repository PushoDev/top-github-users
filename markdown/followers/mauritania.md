...
The `number of followers` of users in Mauritania on `2023/11/24 9:15 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
