...
The `number of followers` of users in Mozambique  on `2024/2/4 11:17 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
