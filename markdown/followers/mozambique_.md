...
The `number of followers` of users in Mozambique  on `2024/3/5 3:22 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
