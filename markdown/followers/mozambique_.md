...
The `number of followers` of users in Mozambique  on `2024/1/5 10:07 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
