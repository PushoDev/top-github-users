...
The `number of followers` of users in Mozambique  on `2024/2/28 3:20 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
