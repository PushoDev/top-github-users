...
The `number of followers` of users in Iceland on `2024/3/19 8:24 AM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `901 users`  in Iceland. You need at least `2 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tumigisla">
				<img src="https://avatars.githubusercontent.com/u/5342961?s=72&u=94120aafcb5062eacfde0082727307ed6a70b8bf&v=4" width="24" alt="Avatar of tumigisla"> tumigisla
			</a><br/>
			Tumi Snær Gíslason
		</td>
		<td>No Company</td>
