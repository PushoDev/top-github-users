...
The `number of followers` of users in Iceland on `2023/11/26 8:08 PM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `914 users`  in Iceland. You need at least `2 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>914</td>
		<td>
			<a href="https://github.com/klauvi">
				<img src="https://avatars.githubusercontent.com/u/6272841?s=72&v=4" width="24" alt="Avatar of klauvi"> klauvi
			</a><br/>
			Finnur Eiríksson
		</td>
		<td>No Company</td>
