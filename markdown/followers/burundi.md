...
The `number of followers` of users in Burundi on `2023/11/22 4:21 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
