...
The `number of followers` of users in Burundi on `2024/1/22 1:56 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
