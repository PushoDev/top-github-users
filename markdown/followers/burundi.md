...
The `number of followers` of users in Burundi on `2024/1/10 2:24 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
