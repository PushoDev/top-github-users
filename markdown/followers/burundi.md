...
The `number of followers` of users in Burundi on `2024/2/6 3:17 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
