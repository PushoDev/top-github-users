...
The `number of followers` of users in Lithuania on `2024/2/10 1:43 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
