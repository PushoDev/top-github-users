...
The `number of followers` of users in Tanzania on `2023/12/22 7:08 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
