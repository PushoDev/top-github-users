...
The `number of followers` of users in Tanzania on `2023/12/13 8:14 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
