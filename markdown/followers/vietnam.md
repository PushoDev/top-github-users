...
The `number of followers` of users in Vietnam on `2024/1/18 12:18 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
