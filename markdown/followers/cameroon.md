...
The `number of followers` of users in Cameroon on `2023/12/29 2:20 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
