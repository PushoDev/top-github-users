...
The `number of followers` of users in Andorra on `2023/12/31 3:15 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
