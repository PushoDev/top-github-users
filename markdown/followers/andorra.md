...
The `number of followers` of users in Andorra on `2024/1/18 3:18 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
