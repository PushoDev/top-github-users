...
The `number of followers` of users in Andorra on `2023/12/13 5:16 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.
