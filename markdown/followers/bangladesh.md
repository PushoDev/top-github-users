...
The `number of followers` of users in Bangladesh on `2023/12/7 9:21 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.
