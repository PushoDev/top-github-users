...
The `number of followers` of users in South Korea on `2023/12/22 3:25 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/yezgoget">
				<img src="https://avatars.githubusercontent.com/u/55784772?s=72&u=b7a40d7dcf76debbca07ddd50ca7175ed8d8c444&v=4" width="24" alt="Avatar of yezgoget"> yezgoget
			</a><br/>
			YE G 
		</td>
		<td>No Company</td>
	...
	<tr>
		<td>973</td>
		<td>
			<a href="https://github.com/g6ling">
	...
	<tr>
		...
		<td>@imwebme, @function-and-mounta @suspensive </td>
		<td>No Twitter Username</td>
		<td>korea, seoul</td>
		<td>83</td>
	</tr>
