...
The `number of followers` of users in South Korea on `2024/2/8 2:20 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@line, @function-and-mounta @spark-kr </td>
		<td>No Twitter Username</td>
		<td>Seoul</td>
		<td>187</td>
	</tr>
	...
	<tr>
		...
		<td><a href="https://twitter.com/keyakoto">keyakoto</a></td>
		<td>Seoul, Republic of Korea</td>
		<td>137</td>
	</tr>
	<tr>
	...
	<tr>
		<td>930</td>
		<td>
			<a href="https://github.com/SungGil-5125">
