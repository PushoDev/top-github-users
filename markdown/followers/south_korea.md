...
The `number of followers` of users in South Korea on `2023/12/19 4:26 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/HeartPattern">
				<img src="https://avatars.githubusercontent.com/u/30573037?s=72&u=af3c3afef62d19719d57552ba41e0bc46511a5b4&v=4" width="24" alt="Avatar of HeartPattern"> HeartPattern
			</a><br/>
			HeartPattern
		</td>
		<td>@scatterlab </td>
