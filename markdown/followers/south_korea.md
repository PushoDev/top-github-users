...
The `number of followers` of users in South Korea on `2024/1/15 2:33 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@remeoursete @nexters @developeracademy-po </td>
		<td>No Twitter Username</td>
		<td>Seoul, Korea</td>
		<td>132</td>
	</tr>
