...
The `number of followers` of users in South Korea on `2024/3/8 5:21 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@line, @korean-fe-article, @with-function, @spark-kr<br/></td>
		<td>No Twitter Username</td>
		<td>Seoul</td>
		<td>197</td>
	</tr>
