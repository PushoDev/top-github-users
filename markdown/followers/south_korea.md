...
The `number of followers` of users in South Korea on `2024/1/3 2:27 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
...
<table>
	...
	<tr>
		...
		<td>@nexters @developeracademy-po </td>
		<td>No Twitter Username</td>
		<td>Seoul, Korea</td>
		<td>131</td>
	</tr>
	...
	<tr>
		<td>881</td>
		<td>
			<a href="https://github.com/predictyson">
	...
	<tr>
		<td>953</td>
		<td>
			<a href="https://github.com/kimsooyoung">
