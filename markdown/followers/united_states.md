...
The `number of followers` of users in United States on `2023/12/19 12:20 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
