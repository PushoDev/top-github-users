...
The `number of followers` of users in Canada on `2024/3/9 6:09 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `956 users`  in Canada. You need at least `192 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>@desterlib </td>
		<td><a href="https://twitter.com/JyothisJayanth">JyothisJayanth</a></td>
		<td>Toronto, CA</td>
		<td>205</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/hasibzunair">
				<img src="https://avatars.githubusercontent.com/u/33185386?s=72&u=05ab8bef06ddefe41239faf867305ad58566c499&v=4" width="24" alt="Avatar of hasibzunair"> hasibzunair
			</a><br/>
			Hasib Zunair
		</td>
