...
The `number of followers` of users in Canada on `2023/12/11 5:23 AM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `963 users`  in Canada. You need at least `184 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/superdev90">
				<img src="https://avatars.githubusercontent.com/u/149831262?s=72&u=aa8edca1a301f78cf09f87790d504593a1c078a7&v=4" width="24" alt="Avatar of superdev90"> superdev90
			</a><br/>
			SuperDev
		</td>
		<td>Techasoft </td>
