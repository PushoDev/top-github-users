...
The `number of followers` of users in Canada on `2024/3/15 5:22 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `954 users`  in Canada. You need at least `192 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/zeno-degen">
				<img src="https://avatars.githubusercontent.com/u/29924624?s=72&u=e99b02ff1ff69e76967862060c0e8c85e961feb8&v=4" width="24" alt="Avatar of zeno-degen"> zeno-degen
			</a><br/>
			zeno
		</td>
		<td>No Company</td>
		<td><a href="https://twitter.com/zeno_degen">zeno_degen</a></td>
		<td>Ontario, Canada</td>
		<td>252</td>
	</tr>
	<tr>
