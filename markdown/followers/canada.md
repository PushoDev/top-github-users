...
The `number of followers` of users in Canada on `2024/3/24 5:10 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `955 users`  in Canada. You need at least `194 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>66</td>
		<td>
			<a href="https://github.com/DanielSmith0831">
				<img src="https://avatars.githubusercontent.com/u/128817762?s=72&u=805179b812ce5ee0ba3a6c11d7e4a7297ed5b09d&v=4" width="24" alt="Avatar of DanielSmith0831"> DanielSmith0831
			</a><br/>
			Daniel Smith
		</td>
		<td>Digitalis </td>
