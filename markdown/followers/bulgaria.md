...
The `number of followers` of users in Bulgaria on `2024/2/29 5:09 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
