...
The `number of followers` of users in Bulgaria on `2024/3/3 4:08 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
