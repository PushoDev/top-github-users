...
The `number of followers` of users in Benin on `2024/2/14 7:07 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/iamhnxt">iamhnxt</a></td>
		<td>Benin City</td>
		<td>1</td>
	</tr>
	<tr>
