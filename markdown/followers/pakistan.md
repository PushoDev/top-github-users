...
The `number of followers` of users in Pakistan on `2024/4/1 4:24 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
