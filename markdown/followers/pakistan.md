...
The `number of followers` of users in Pakistan on `2024/2/10 1:22 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
