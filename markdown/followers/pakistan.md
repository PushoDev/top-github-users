...
The `number of followers` of users in Pakistan on `2024/1/11 3:08 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
