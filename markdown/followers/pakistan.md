...
The `number of followers` of users in Pakistan on `2023/12/9 5:08 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
