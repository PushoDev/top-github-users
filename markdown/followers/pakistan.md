...
The `number of followers` of users in Pakistan on `2024/3/26 6:16 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
