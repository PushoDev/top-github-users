...
The `number of followers` of users in Pakistan on `2023/11/30 5:09 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
