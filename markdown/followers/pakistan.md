...
The `number of followers` of users in Pakistan on `2024/1/17 3:09 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
