...
The `number of followers` of users in Pakistan on `2024/3/5 8:25 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
