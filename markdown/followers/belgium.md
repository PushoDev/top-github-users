...
The `number of followers` of users in Belgium on `2023/12/10 10:21 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
