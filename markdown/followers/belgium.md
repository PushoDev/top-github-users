...
The `number of followers` of users in Belgium on `2024/3/30 10:09 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		...
		<td>@pixelexperience @p-404 @aospa </td>
		<td>No Twitter Username</td>
		<td>Belgium</td>
		<td>181</td>
	</tr>
	...
	<tr>
		...
		<td>Egonix / Myconsultation.be /<br/>Dog&dev<br/></td>
		<td>No Twitter Username</td>
		<td>Belgium</td>
		<td>56</td>
	</tr>
	...
	<tr>
		<td>929</td>
		<td>
			<a href="https://github.com/realeroberto">
	...
	<tr>
		<td>937</td>
		<td>
			<a href="https://github.com/samirm00">
