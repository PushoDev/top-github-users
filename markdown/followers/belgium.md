...
The `number of followers` of users in Belgium on `2024/4/2 9:23 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
