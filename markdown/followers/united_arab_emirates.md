...
The `number of followers` of users in United Arab Emirates on `2024/4/1 9:13 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.
