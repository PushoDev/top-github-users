...
The `number of followers` of users in Kuwait on `2023/12/30 12:32 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
