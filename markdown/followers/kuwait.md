...
The `number of followers` of users in Kuwait on `2024/3/7 4:22 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
