...
The `number of followers` of users in France on `2024/1/4 1:26 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `953 users`  in France. You need at least `161 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/edomt">
				<img src="https://avatars.githubusercontent.com/u/7103774?s=72&u=01a6f51f408ca6694d6cf6e1e04fb5beee0c1bcd&v=4" width="24" alt="Avatar of edomt"> edomt
			</a><br/>
			Edouard Mathieu
		</td>
		<td>No Company</td>
