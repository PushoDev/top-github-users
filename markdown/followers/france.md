...
The `number of followers` of users in France on `2023/12/17 3:22 PM UTC`. This list contains users from `France` and cities `Paris` `Marseille` `Lyon` `Bordeaux` `Toulouse` `Strasbourg` `Nice` `Nantes` `Montpellier` `Lille`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `952 users`  in France. You need at least `160 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Liris // École Centrale<br/>De<br/>Lyon<br/></td>
		<td><a href="https://twitter.com/romsson">romsson</a></td>
		<td>Lyon, France</td>
		<td>160</td>
	</tr>
	<tr>
