...
The `number of followers` of users in Venezuela on `2023/12/4 1:26 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
