...
The `number of followers` of users in Venezuela on `2024/1/30 1:22 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
