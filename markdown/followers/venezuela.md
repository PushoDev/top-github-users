...
The `number of followers` of users in Venezuela on `2024/2/17 9:08 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
