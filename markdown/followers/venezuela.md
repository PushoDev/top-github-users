...
The `number of followers` of users in Venezuela on `2024/3/15 2:21 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
