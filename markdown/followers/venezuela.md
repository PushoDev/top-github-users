...
The `number of followers` of users in Venezuela on `2024/2/14 9:22 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
