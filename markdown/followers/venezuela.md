...
The `number of followers` of users in Venezuela on `2024/1/21 11:19 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
