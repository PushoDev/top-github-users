...
The `number of followers` of users in Venezuela on `2024/2/23 6:25 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
