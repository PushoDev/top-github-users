...
The `number of followers` of users in Venezuela on `2024/1/12 11:20 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
