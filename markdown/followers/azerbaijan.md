...
The `number of followers` of users in Azerbaijan on `2024/3/15 9:20 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
