...
The `number of followers` of users in Azerbaijan on `2023/12/22 7:18 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
