...
The `number of followers` of users in Saudi Arabia on `2024/3/20 12:32 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
