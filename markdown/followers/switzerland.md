...
The `number of followers` of users in Switzerland on `2024/3/29 6:25 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
