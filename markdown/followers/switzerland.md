...
The `number of followers` of users in Switzerland on `2023/12/4 7:10 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
