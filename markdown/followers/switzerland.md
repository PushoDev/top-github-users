...
The `number of followers` of users in Switzerland on `2023/12/25 5:22 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
