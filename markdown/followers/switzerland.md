...
The `number of followers` of users in Switzerland on `2023/12/22 6:16 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
