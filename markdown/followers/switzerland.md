...
The `number of followers` of users in Switzerland on `2024/3/2 8:08 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
