...
The `number of followers` of users in Switzerland on `2024/4/1 5:24 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
