...
The `number of followers` of users in Switzerland on `2024/3/8 8:09 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
