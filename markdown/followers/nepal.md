...
The `number of followers` of users in Nepal on `2024/1/5 11:20 AM UTC`. This list contains users from `Nepal` and cities `Kathmandu` `Pokhara` `Lalitpur` `Bharatpur` `Biratnagar` `Birgunj` `Janakpur` `Hetauda`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `984 users`  in Nepal. You need at least `22 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Bikrambhattaraii">
				<img src="https://avatars.githubusercontent.com/u/64210343?s=72&u=455cd590b123df147c5121838578196175c70f34&v=4" width="24" alt="Avatar of Bikrambhattaraii"> Bikrambhattaraii
			</a><br/>
			bikram bhattarai
		</td>
		<td>No Company</td>
