...
The `number of followers` of users in Ireland on `2023/12/20 9:09 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
