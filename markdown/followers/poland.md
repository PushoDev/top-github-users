...
The `number of followers` of users in Poland on `2023/12/12 8:10 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
