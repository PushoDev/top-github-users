...
The `number of followers` of users in Poland on `2024/1/2 6:16 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.
