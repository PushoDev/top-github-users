...
The `number of followers` of users in Colombia on `2023/11/23 2:33 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
