...
The `number of followers` of users in Colombia on `2024/1/25 8:16 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
