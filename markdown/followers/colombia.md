...
The `number of followers` of users in Colombia on `2024/2/15 4:25 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
