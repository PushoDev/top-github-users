...
The `number of followers` of users in Belarus on `2024/1/3 8:08 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
...
<table>
	...
	<tr>
		<td>159</td>
		<td>
			<a href="https://github.com/turnme0n">
				<img src="https://avatars.githubusercontent.com/u/117026353?s=72&v=4" width="24" alt="Avatar of turnme0n"> turnme0n
			</a><br/>
			Daniil
		</td>
		<td>No Company</td>
