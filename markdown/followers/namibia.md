...
The `number of followers` of users in Namibia on `2023/12/15 1:13 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
