...
The `number of followers` of users in Namibia on `2023/11/30 1:13 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
