...
The `number of followers` of users in Philippines on `2023/12/21 6:11 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
