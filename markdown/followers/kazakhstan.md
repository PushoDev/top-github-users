...
The `number of followers` of users in Kazakhstan on `2023/12/6 1:53 AM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/abs0luty">
				<img src="https://avatars.githubusercontent.com/u/68709264?s=72&u=31745d1f01c5d886678d3277c1522444e7b42db5&v=4" width="24" alt="Avatar of abs0luty"> abs0luty
			</a><br/>
			Adi Salimgereev
		</td>
		<td>Quantumatic </td>
