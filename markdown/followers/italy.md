...
The `number of followers` of users in Italy on `2024/2/27 3:09 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alcestide">
				<img src="https://avatars.githubusercontent.com/u/106203061?s=72&u=d4ec46caa8bbc3b7795d37cd9fefaf3775ebd5b0&v=4" width="24" alt="Avatar of alcestide"> alcestide
			</a><br/>
			Angelo Panariti
		</td>
		<td>Sismed S.r.l. </td>
