...
The `number of followers` of users in Italy on `2024/1/7 9:09 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `973 users`  in Italy. You need at least `68 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>973</td>
		<td>
			<a href="https://github.com/sarovin">
				<img src="https://avatars.githubusercontent.com/u/5980398?s=72&u=ff402e2c25537ac5db0020f3b7dc63453d73958b&v=4" width="24" alt="Avatar of sarovin"> sarovin
			</a><br/>
			Saro Vindigni
		</td>
		<td>@bolket </td>
