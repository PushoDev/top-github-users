...
The `number of followers` of users in Italy on `2024/1/4 9:09 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `972 users`  in Italy. You need at least `68 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/aamaricci">
				<img src="https://avatars.githubusercontent.com/u/2298328?s=72&u=64388d908dcf457edae4d4eb312cbc53b77e56c5&v=4" width="24" alt="Avatar of aamaricci"> aamaricci
			</a><br/>
			Adriano Amaricci
		</td>
