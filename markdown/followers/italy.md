...
The `number of followers` of users in Italy on `2024/3/10 12:30 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alcestide">
				<img src="https://avatars.githubusercontent.com/u/106203061?s=72&u=616768a3b2a345ceceaf8fb43396cc77a5a81783&v=4" width="24" alt="Avatar of alcestide"> alcestide
			</a><br/>
			Angelo Panariti
		</td>
		<td>No Company</td>
