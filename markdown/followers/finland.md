...
The `number of followers` of users in Finland on `2024/2/3 2:19 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
