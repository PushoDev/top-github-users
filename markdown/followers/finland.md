...
The `number of followers` of users in Finland on `2023/11/26 3:21 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
