...
The `number of followers` of users in Finland on `2024/1/7 1:13 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
