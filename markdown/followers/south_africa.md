...
The `number of followers` of users in South Africa on `2024/1/21 2:02 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
