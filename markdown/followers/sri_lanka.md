...
The `number of followers` of users in Sri Lanka on `2023/12/25 4:13 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.
