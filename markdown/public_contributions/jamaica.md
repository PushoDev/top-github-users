...
The `public contributions` by users in Jamaica on `2024/1/10 9:19 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
...
<table>
	...
	<tr>
		...
		<td>@xxanoss, @worldofwindows [abandoned], @xashos<br/>[closed]<br/></td>
		<td>No Twitter Username</td>
	...
	<tr>
		<td>147</td>
		<td>
			<a href="https://github.com/TheAllRounder66">
				<img src="https://avatars.githubusercontent.com/u/118129498?s=72&u=1e8d97276b23cd065dd88cf4a1fed636fb52d8db&v=4" width="24" alt="Avatar of TheAllRounder66"> TheAllRounder66
			</a><br/>
			Bradly
		</td>
		<td>No Company</td>
