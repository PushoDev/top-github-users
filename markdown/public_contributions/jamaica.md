...
The `public contributions` by users in Jamaica on `2024/1/7 9:19 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.
...
<table>
	...
	<tr>
		...
		<td>@xxanoss, @worldofwindows [abandoned] </td>
		<td>No Twitter Username</td>
