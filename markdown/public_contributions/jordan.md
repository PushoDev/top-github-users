...
The `public contributions` by users in Jordan on `2023/11/27 1:52 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
