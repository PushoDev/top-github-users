...
The `public contributions` by users in Jordan on `2023/11/30 1:12 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
