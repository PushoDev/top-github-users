...
The `public contributions` by users in Jordan on `2023/11/24 2:24 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
