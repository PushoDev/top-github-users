...
The `public contributions` by users in Bulgaria on `2024/1/13 12:35 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
