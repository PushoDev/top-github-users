...
The `public contributions` by users in Nigeria on `2024/1/8 1:26 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `994 users`  in Nigeria. You need at least `63 followers` to be on this list.
