...
The `public contributions` by users in Nigeria on `2023/11/30 3:22 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Ginohmk">
				<img src="https://avatars.githubusercontent.com/u/58771507?s=72&v=4" width="24" alt="Avatar of Ginohmk"> Ginohmk
			</a><br/>
			Kanu Mike Chibundu
		</td>
		<td>@microverseinc  </td>
