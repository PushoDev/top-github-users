...
The `public contributions` by users in Finland on `2023/12/17 3:09 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
