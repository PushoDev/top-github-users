...
The `public contributions` by users in Finland on `2023/11/23 3:23 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
