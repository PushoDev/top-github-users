...
The `public contributions` by users in Finland on `2024/2/9 12:32 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
