...
The `public contributions` by users in Afghanistan on `2024/1/3 2:07 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/nazirahmad1">
				<img src="https://avatars.githubusercontent.com/u/143400276?s=72&u=66d7608f46fbdd3ea29295662cb67d03a289b9e9&v=4" width="24" alt="Avatar of nazirahmad1"> nazirahmad1
			</a><br/>
			Nazir Ahmad Rahmaty
		</td>
		<td>No Company</td>
