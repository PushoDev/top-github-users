...
The `public contributions` by users in United Kingdom on `2024/1/3 9:24 AM UTC`. This list contains users from `United Kingdom` and cities `London` `Birmingham` `Edinburgh` `Manchester` `Glasgow` `Liverpool` `Bristol`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `955 users`  in United Kingdom. You need at least `192 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>317</td>
		<td>
			<a href="https://github.com/electronicboy">
				<img src="https://avatars.githubusercontent.com/u/1228900?s=72&u=649f1c3dd4f700ad134d7958c30a4fb1a3fd2142&v=4" width="24" alt="Avatar of electronicboy"> electronicboy
			</a><br/>
			Shane Freeder
		</td>
		<td>No Company</td>
		<td><a href="https://twitter.com/boyetronic">boyetronic</a></td>
		<td>Liverpool, England</td>
		<td>258</td>
	</tr>
	<tr>
