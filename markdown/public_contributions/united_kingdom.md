...
The `public contributions` by users in United Kingdom on `2023/12/1 11:22 AM UTC`. This list contains users from `United Kingdom` and cities `London` `Birmingham` `Edinburgh` `Manchester` `Glasgow` `Liverpool` `Bristol`.
...
<table>
	...
	<tr>
		<td>525</td>
		<td>
			<a href="https://github.com/ayrton04">
				<img src="https://avatars.githubusercontent.com/u/5042191?s=72&v=4" width="24" alt="Avatar of ayrton04"> ayrton04
			</a><br/>
			Tom Moore
		</td>
