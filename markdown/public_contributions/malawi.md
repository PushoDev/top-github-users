...
The `public contributions` by users in Malawi on `2024/1/5 4:13 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/cyberthirty">
				<img src="https://avatars.githubusercontent.com/u/141743797?s=72&v=4" width="24" alt="Avatar of cyberthirty"> cyberthirty
			</a><br/>
			Lucky Ngabuh
		</td>
		<td>No Company</td>
