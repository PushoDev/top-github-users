...
The `public contributions` by users in Luxembourg on `2023/12/30 3:08 AM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Nekika">
				<img src="https://avatars.githubusercontent.com/u/46004811?s=72&v=4" width="24" alt="Avatar of Nekika"> Nekika
			</a><br/>
			Hugo Jahnke
		</td>
		<td>Autopass </td>
