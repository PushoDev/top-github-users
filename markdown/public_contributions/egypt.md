...
The `public contributions` by users in Egypt on `2023/12/20 12:15 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
