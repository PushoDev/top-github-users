...
The `public contributions` by users in Azerbaijan on `2024/2/2 8:20 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
