...
The `public contributions` by users in Azerbaijan on `2023/12/28 6:25 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
