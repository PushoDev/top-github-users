...
The `public contributions` by users in Azerbaijan on `2023/11/28 8:23 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
