...
The `public contributions` and `private contributions` by users in Jordan on `2023/12/3 1:15 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
