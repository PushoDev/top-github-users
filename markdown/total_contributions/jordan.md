...
The `public contributions` and `private contributions` by users in Jordan on `2024/3/31 12:15 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
