...
The `public contributions` and `private contributions` by users in Jordan on `2023/12/9 1:10 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
