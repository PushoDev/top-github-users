...
The `public contributions` and `private contributions` by users in Turkey on `2024/1/30 9:22 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
