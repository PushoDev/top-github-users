...
The `public contributions` and `private contributions` by users in Turkey on `2024/2/14 5:21 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
