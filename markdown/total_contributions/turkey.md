...
The `public contributions` and `private contributions` by users in Turkey on `2023/12/25 8:08 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
