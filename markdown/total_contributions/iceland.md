...
The `public contributions` and `private contributions` by users in Iceland on `2024/2/3 7:08 PM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
