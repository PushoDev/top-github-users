...
The `public contributions` and `private contributions` by users in Botswana on `2023/12/2 1:45 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
