...
The `public contributions` and `private contributions` by users in Botswana on `2023/12/17 1:56 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
