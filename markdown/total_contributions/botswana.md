...
The `public contributions` and `private contributions` by users in Botswana on `2024/2/23 6:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
...
<table>
	...
	<tr>
		<td>249</td>
		<td>
			<a href="https://github.com/sgdifferent90">
				<img src="https://avatars.githubusercontent.com/u/161036859?s=72&u=338fa45e3bfe147f1bfb732b8823ce3cae23e0c9&v=4" width="24" alt="Avatar of sgdifferent90"> sgdifferent90
			</a><br/>
			Sergio Gray
		</td>
		<td>Johnson, Tucker And Kelly<br/></td>
		<td>No Twitter Username</td>
		<td>Botswana</td>
		<td>1</td>
		<td>1</td>
