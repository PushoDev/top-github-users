...
The `public contributions` and `private contributions` by users in Ghana on `2024/3/25 5:22 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
