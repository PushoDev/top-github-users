...
The `public contributions` and `private contributions` by users in Ghana on `2024/2/9 2:19 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
