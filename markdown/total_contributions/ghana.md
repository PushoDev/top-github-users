...
The `public contributions` and `private contributions` by users in Ghana on `2024/3/4 7:59 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.
