...
The `public contributions` and `private contributions` by users in Lithuania on `2024/1/8 2:30 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
