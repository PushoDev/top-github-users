...
The `public contributions` and `private contributions` by users in Lithuania on `2023/12/30 2:24 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
