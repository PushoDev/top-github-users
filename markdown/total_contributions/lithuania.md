...
The `public contributions` and `private contributions` by users in Lithuania on `2023/12/12 4:25 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
