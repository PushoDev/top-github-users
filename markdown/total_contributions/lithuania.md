...
The `public contributions` and `private contributions` by users in Lithuania on `2024/2/15 11:22 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
