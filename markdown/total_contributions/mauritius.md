...
The `public contributions` and `private contributions` by users in Mauritius on `2023/12/9 9:07 AM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `923 users`  in Mauritius. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>197</td>
		<td>
			<a href="https://github.com/AkashSeewoosurran">
				<img src="https://avatars.githubusercontent.com/u/37662383?s=72&v=4" width="24" alt="Avatar of AkashSeewoosurran"> AkashSeewoosurran
			</a><br/>
			Luv Seewoosurran
		</td>
		<td>Infosys </td>
