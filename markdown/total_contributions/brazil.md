...
The `public contributions` and `private contributions` by users in Brazil on `2024/3/30 1:10 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/CauanDZN">
				<img src="https://avatars.githubusercontent.com/u/91569130?s=72&u=d3bc579d82f00532b10c3e6ca4f333ca4e6992fb&v=4" width="24" alt="Avatar of CauanDZN"> CauanDZN
			</a><br/>
			Cauan Victor
		</td>
