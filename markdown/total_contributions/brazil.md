...
The `public contributions` and `private contributions` by users in Brazil on `2024/1/21 11:23 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LucasAlv3s">
				<img src="https://avatars.githubusercontent.com/u/80328704?s=72&u=3520febf76d33348ee38c1fa4cf7dd330043cd89&v=4" width="24" alt="Avatar of LucasAlv3s"> LucasAlv3s
			</a><br/>
			Lucas Alves
		</td>
		<td>No Company</td>
