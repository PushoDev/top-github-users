...
The `public contributions` and `private contributions` by users in Brazil on `2024/2/6 1:45 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `958 users`  in Brazil. You need at least `220 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/WSTxda">
				<img src="https://avatars.githubusercontent.com/u/37253994?s=72&u=18fece827d7e1b9195d6eef5c7755848e73c0472&v=4" width="24" alt="Avatar of WSTxda"> WSTxda
			</a><br/>
			WSTxda
		</td>
		<td>Wstprojects </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/JunioDo">
				<img src="https://avatars.githubusercontent.com/u/134664641?s=72&u=696d7b24a0c297bf6185a4f4e5a7a867aa7cb563&v=4" width="24" alt="Avatar of JunioDo"> JunioDo
			</a><br/>
			Junior
		</td>
		<td>Freelancer </td>
