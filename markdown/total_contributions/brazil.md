...
The `public contributions` and `private contributions` by users in Brazil on `2024/2/3 1:58 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `959 users`  in Brazil. You need at least `219 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/isyuricunha">
				<img src="https://avatars.githubusercontent.com/u/115634315?s=72&u=34dc89aa38de175318b40c012651c6acce583a99&v=4" width="24" alt="Avatar of isyuricunha"> isyuricunha
			</a><br/>
			Yuri Cunha
		</td>
		<td>No Company</td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/arthurfiorette">
				<img src="https://avatars.githubusercontent.com/u/47537704?s=72&u=c2cc55418f2a28a822078a27cbdea8f55aded73d&v=4" width="24" alt="Avatar of arthurfiorette"> arthurfiorette
			</a><br/>
			Arthur Fiorette
		</td>
		<td>Kasco R&d </td>
