...
The `public contributions` and `private contributions` by users in Brazil on `2023/12/20 1:43 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `961 users`  in Brazil. You need at least `207 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/muniz95">
				<img src="https://avatars.githubusercontent.com/u/4670954?s=72&v=4" width="24" alt="Avatar of muniz95"> muniz95
			</a><br/>
			Rodrigo Muniz
		</td>
		<td>@rmtecnologia  </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bmotadev">
				<img src="https://avatars.githubusercontent.com/u/123843027?s=72&u=1dc27d402e8ae11fa7588c9427daa1ea32adb4f3&v=4" width="24" alt="Avatar of bmotadev"> bmotadev
			</a><br/>
			Bruno Mota
		</td>
		<td>No Company</td>
