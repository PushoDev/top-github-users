...
The `public contributions` and `private contributions` by users in Brazil on `2023/12/14 2:28 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `960 users`  in Brazil. You need at least `216 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/AlexandreSanlim">AlexandreSanlim</a></td>
		<td>Brazil</td>
		<td>151</td>
		<td>199</td>
	</tr>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Gurtinho">
				<img src="https://avatars.githubusercontent.com/u/50364832?s=72&u=6e47b187b45c7261371834ae5df96817e898c584&v=4" width="24" alt="Avatar of Gurtinho"> Gurtinho
			</a><br/>
			Gustavo Litter
		</td>
		<td>Okton </td>
