...
The `public contributions` and `private contributions` by users in Brazil on `2024/3/3 3:21 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
...
<table>
	...
	<tr>
		...
		<td>Software Architect @tarkenag </td>
		<td>No Twitter Username</td>
