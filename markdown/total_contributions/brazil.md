...
The `public contributions` and `private contributions` by users in Brazil on `2024/2/17 9:09 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `958 users`  in Brazil. You need at least `221 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/mirianfsilva">
				<img src="https://avatars.githubusercontent.com/u/29445968?s=72&u=b979c9976113c1f9be78d4f76d81682b41b83527&v=4" width="24" alt="Avatar of mirianfsilva"> mirianfsilva
			</a><br/>
			Mírian Silva
		</td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/WSTxda">
				<img src="https://avatars.githubusercontent.com/u/37253994?s=72&u=f864ac25429578242fbb464828015be50d3be52c&v=4" width="24" alt="Avatar of WSTxda"> WSTxda
			</a><br/>
			WSTxda
		</td>
		<td>Wstprojects </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/dougkalash">
				<img src="https://avatars.githubusercontent.com/u/149725576?s=72&v=4" width="24" alt="Avatar of dougkalash"> dougkalash
			</a><br/>
			DouG Kalashnikov
		</td>
		<td>High Class </td>
