...
The `public contributions` and `private contributions` by users in Brazil on `2023/12/5 2:33 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `960 users`  in Brazil. You need at least `215 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/lklima">
				<img src="https://avatars.githubusercontent.com/u/44346970?s=72&u=034126b18ac52e4e9ceddb1aa94bb222343c79d3&v=4" width="24" alt="Avatar of lklima"> lklima
			</a><br/>
			Lucas Lima
		</td>
		<td>@pietaxtech </td>
