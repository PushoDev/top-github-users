...
The `public contributions` and `private contributions` by users in Tanzania on `2023/11/25 9:07 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
