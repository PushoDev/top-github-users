...
The `public contributions` and `private contributions` by users in Tanzania on `2023/12/19 8:15 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
