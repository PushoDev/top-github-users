...
The `public contributions` and `private contributions` by users in Tanzania on `2024/2/20 2:18 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
