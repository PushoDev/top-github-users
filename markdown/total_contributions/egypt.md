...
The `public contributions` and `private contributions` by users in Egypt on `2024/1/31 1:08 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
