...
The `public contributions` and `private contributions` by users in Egypt on `2024/1/16 11:09 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
