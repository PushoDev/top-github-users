...
The `public contributions` and `private contributions` by users in Egypt on `2024/3/22 1:45 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
