...
The `public contributions` and `private contributions` by users in Egypt on `2024/2/3 12:31 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
