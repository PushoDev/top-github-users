...
The `public contributions` and `private contributions` by users in Switzerland on `2023/12/10 7:09 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `902 users`  in Switzerland. You need at least `73 followers` to be on this list.
