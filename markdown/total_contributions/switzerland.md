...
The `public contributions` and `private contributions` by users in Switzerland on `2024/1/24 6:17 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
