...
The `public contributions` and `private contributions` by users in Switzerland on `2024/2/22 11:24 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `898 users`  in Switzerland. You need at least `75 followers` to be on this list.
