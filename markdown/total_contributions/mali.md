...
The `public contributions` and `private contributions` by users in Mali on `2024/2/22 1:40 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
