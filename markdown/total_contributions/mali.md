...
The `public contributions` and `private contributions` by users in Mali on `2024/3/10 8:04 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
