...
The `public contributions` and `private contributions` by users in Mali on `2023/12/21 6:10 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
