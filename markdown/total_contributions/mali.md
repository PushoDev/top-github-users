...
The `public contributions` and `private contributions` by users in Mali on `2024/2/19 2:23 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
