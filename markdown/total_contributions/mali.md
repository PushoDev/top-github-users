...
The `public contributions` and `private contributions` by users in Mali on `2024/3/16 7:14 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
