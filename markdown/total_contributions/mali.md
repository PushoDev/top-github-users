...
The `public contributions` and `private contributions` by users in Mali on `2023/12/3 7:15 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
