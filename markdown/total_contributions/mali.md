...
The `public contributions` and `private contributions` by users in Mali on `2023/12/18 7:16 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
