...
The `public contributions` and `private contributions` by users in Mali on `2024/2/10 4:04 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
