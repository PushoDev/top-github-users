...
The `public contributions` and `private contributions` by users in Mali on `2024/3/1 9:16 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
