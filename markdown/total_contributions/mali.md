...
The `public contributions` and `private contributions` by users in Mali on `2023/11/27 8:11 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
