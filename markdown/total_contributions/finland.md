...
The `public contributions` and `private contributions` by users in Finland on `2024/1/19 1:16 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
