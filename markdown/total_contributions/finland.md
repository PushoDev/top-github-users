...
The `public contributions` and `private contributions` by users in Finland on `2023/11/23 3:23 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `955 users`  in Finland. You need at least `37 followers` to be on this list.
