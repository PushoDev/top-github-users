...
The `public contributions` and `private contributions` by users in Finland on `2024/2/6 2:21 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
