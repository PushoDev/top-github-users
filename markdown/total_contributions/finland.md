...
The `public contributions` and `private contributions` by users in Finland on `2024/1/28 2:19 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
