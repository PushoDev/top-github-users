...
The `public contributions` and `private contributions` by users in Finland on `2024/1/13 1:12 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
