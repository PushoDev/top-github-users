...
The `public contributions` and `private contributions` by users in Finland on `2023/12/5 3:11 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jasalt">
				<img src="https://avatars.githubusercontent.com/u/2306521?s=72&u=0aa47914ba882ee5fc986ead6348a074dfa830ea&v=4" width="24" alt="Avatar of jasalt"> jasalt
			</a><br/>
			Jarkko Saltiola
		</td>
		<td>Freelancer </td>
