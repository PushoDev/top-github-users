...
The `public contributions` and `private contributions` by users in Finland on `2023/12/26 1:13 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
