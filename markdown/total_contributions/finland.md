...
The `public contributions` and `private contributions` by users in Finland on `2024/2/18 10:22 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
