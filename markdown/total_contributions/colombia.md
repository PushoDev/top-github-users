...
The `public contributions` and `private contributions` by users in Colombia on `2024/1/16 6:27 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
