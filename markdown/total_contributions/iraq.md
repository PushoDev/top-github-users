...
The `public contributions` and `private contributions` by users in Iraq on `2023/12/2 9:19 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
