...
The `public contributions` and `private contributions` by users in Iraq on `2024/3/13 10:22 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.
