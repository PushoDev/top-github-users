...
The `public contributions` and `private contributions` by users in Georgia on `2023/12/2 4:10 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.
