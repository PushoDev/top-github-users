...
The `public contributions` and `private contributions` by users in Nicaragua on `2024/4/1 2:28 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
