...
The `public contributions` and `private contributions` by users in Nicaragua on `2023/11/24 4:09 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
