...
The `public contributions` and `private contributions` by users in Venezuela on `2024/1/15 11:20 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
