...
The `public contributions` and `private contributions` by users in Latvia on `2023/11/30 4:14 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
