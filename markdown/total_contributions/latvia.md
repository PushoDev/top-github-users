...
The `public contributions` and `private contributions` by users in Latvia on `2024/3/1 6:10 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
