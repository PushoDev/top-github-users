...
The `public contributions` and `private contributions` by users in Latvia on `2024/3/28 3:22 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jooselohi">
				<img src="https://avatars.githubusercontent.com/u/119803786?s=72&u=3f81b6e6cd0de9e749f7aa36237bd4b69dbaac1c&v=4" width="24" alt="Avatar of jooselohi"> jooselohi
			</a><br/>
			Joose Lohi
		</td>
		<td>No Company</td>
