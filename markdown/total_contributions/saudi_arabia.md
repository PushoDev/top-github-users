...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2023/12/18 11:21 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
