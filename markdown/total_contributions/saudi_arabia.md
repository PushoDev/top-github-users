...
The `public contributions` and `private contributions` by users in Saudi Arabia on `2023/12/24 10:07 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.
