...
The `public contributions` and `private contributions` by users in Taiwan on `2024/1/4 6:15 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
