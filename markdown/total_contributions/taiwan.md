...
The `public contributions` and `private contributions` by users in Taiwan on `2023/11/23 1:12 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
