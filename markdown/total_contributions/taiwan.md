...
The `public contributions` and `private contributions` by users in Taiwan on `2023/12/8 8:16 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
