...
The `public contributions` and `private contributions` by users in Azerbaijan on `2023/11/22 3:22 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
