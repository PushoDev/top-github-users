...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/4/2 7:22 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
