...
The `public contributions` and `private contributions` by users in Azerbaijan on `2023/12/7 8:23 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
