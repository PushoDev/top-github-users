...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/2/14 4:24 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
