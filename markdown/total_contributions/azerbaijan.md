...
The `public contributions` and `private contributions` by users in Azerbaijan on `2023/11/25 9:19 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
