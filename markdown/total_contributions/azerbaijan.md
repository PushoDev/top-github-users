...
The `public contributions` and `private contributions` by users in Azerbaijan on `2024/1/6 6:24 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.
