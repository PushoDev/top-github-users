...
The `public contributions` and `private contributions` by users in Norway on `2023/12/21 2:22 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
