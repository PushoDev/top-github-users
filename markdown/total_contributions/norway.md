...
The `public contributions` and `private contributions` by users in Norway on `2024/1/20 2:11 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
