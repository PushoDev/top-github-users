...
The `public contributions` and `private contributions` by users in Norway on `2023/12/3 4:11 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
