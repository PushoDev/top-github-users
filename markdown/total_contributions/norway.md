...
The `public contributions` and `private contributions` by users in Norway on `2024/2/10 12:32 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
