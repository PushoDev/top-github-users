...
The `public contributions` and `private contributions` by users in Norway on `2023/11/24 5:10 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
