...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/12/9 12:15 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/belarmino__jr">belarmino__jr</a></td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/manuujunior">
				<img src="https://avatars.githubusercontent.com/u/99757118?s=72&v=4" width="24" alt="Avatar of manuujunior"> manuujunior
			</a><br/>
			Manuel Dinis Júnior
		</td>
		<td>No Company</td>
