...
The `public contributions` and `private contributions` by users in Mozambique  on `2023/11/30 12:15 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
