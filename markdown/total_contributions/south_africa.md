...
The `public contributions` and `private contributions` by users in South Africa on `2024/3/17 4:10 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/chop-dev">
				<img src="https://avatars.githubusercontent.com/u/19818797?s=72&u=02b1d2bee50af80b52ab55cc0bd5b70f93528342&v=4" width="24" alt="Avatar of chop-dev"> chop-dev
			</a><br/>
			Raynard Vermeulen
		</td>
		<td>@faustlink </td>
