...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/2/14 12:16 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
