...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/3/3 6:14 AM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
