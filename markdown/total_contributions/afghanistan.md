...
The `public contributions` and `private contributions` by users in Afghanistan on `2023/11/25 5:07 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
