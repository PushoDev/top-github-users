...
The `public contributions` and `private contributions` by users in Afghanistan on `2024/1/24 3:23 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.
