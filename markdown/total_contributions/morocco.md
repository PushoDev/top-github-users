...
The `public contributions` and `private contributions` by users in Morocco on `2024/1/23 10:09 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/nouraellm">
				<img src="https://avatars.githubusercontent.com/u/26191219?s=72&u=252b9af992fb1f75047103f8b13f0e7379285364&v=4" width="24" alt="Avatar of nouraellm"> nouraellm
			</a><br/>
			Flare
		</td>
		<td>No Company</td>
