...
The `public contributions` and `private contributions` by users in Morocco on `2023/12/6 11:20 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AnasFiguigui">
				<img src="https://avatars.githubusercontent.com/u/92400545?s=72&u=ae2a0afd63332760b85b5a85f3b92be7c09ab04b&v=4" width="24" alt="Avatar of AnasFiguigui"> AnasFiguigui
			</a><br/>
			Anas
		</td>
		<td>No Company</td>
