...
The `public contributions` and `private contributions` by users in Morocco on `2023/12/15 11:20 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Wiran-Larbi">
				<img src="https://avatars.githubusercontent.com/u/71338128?s=72&u=a29b613de5585382235a9e113bca13e1010773d1&v=4" width="24" alt="Avatar of Wiran-Larbi"> Wiran-Larbi
			</a><br/>
			DotCipher
		</td>
		<td>No Company</td>
