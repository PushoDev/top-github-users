...
The `public contributions` and `private contributions` by users in Ecuador on `2023/11/23 10:22 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
