...
The `public contributions` and `private contributions` by users in Burkina Faso on `2023/12/29 12:55 AM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
