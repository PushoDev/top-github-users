...
The `public contributions` and `private contributions` by users in Burkina Faso on `2023/11/22 3:16 PM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.
