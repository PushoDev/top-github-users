...
The `public contributions` and `private contributions` by users in Syria on `2023/11/28 7:19 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
