...
The `public contributions` and `private contributions` by users in Slovenia on `2023/12/31 1:16 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
