...
The `public contributions` and `private contributions` by users in Malta on `2023/12/12 8:15 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/PushoDev/top-github-users).

There are `897 users`  in Malta. You need at least `1 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/EnigmaMage">
				<img src="https://avatars.githubusercontent.com/u/85458225?s=72&u=2adf8fdaec09030164625c5af8dfe088b4337e28&v=4" width="24" alt="Avatar of EnigmaMage"> EnigmaMage
			</a><br/>
