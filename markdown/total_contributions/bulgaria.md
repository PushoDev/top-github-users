...
The `public contributions` and `private contributions` by users in Bulgaria on `2024/3/12 2:20 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
