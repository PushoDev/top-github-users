...
The `public contributions` and `private contributions` by users in Vietnam on `2023/12/22 1:14 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.
