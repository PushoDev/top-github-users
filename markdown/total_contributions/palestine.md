...
The `public contributions` and `private contributions` by users in Palestine on `2024/3/20 6:24 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
