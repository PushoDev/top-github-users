...
The `public contributions` and `private contributions` by users in Palestine on `2024/2/13 1:23 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
