...
The `public contributions` and `private contributions` by users in Palestine on `2023/11/27 6:14 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
