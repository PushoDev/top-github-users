...
The `public contributions` and `private contributions` by users in Palestine on `2023/12/27 3:21 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.
