...
The `public contributions` and `private contributions` by users in Greece on `2023/11/23 6:25 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
