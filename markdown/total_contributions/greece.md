...
The `public contributions` and `private contributions` by users in Greece on `2024/3/28 6:15 AM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
