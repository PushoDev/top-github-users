...
The `public contributions` and `private contributions` by users in Paraguay on `2023/12/30 4:25 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.
