...
The `public contributions` and `private contributions` by users in Angola on `2023/12/25 4:24 PM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jesimielnobrega">
				<img src="https://avatars.githubusercontent.com/u/117456844?s=72&u=66d981b9eee1a66d017d76faa7dcf78b9cd70813&v=4" width="24" alt="Avatar of jesimielnobrega"> jesimielnobrega
			</a><br/>
			Jesimiel Nóbrega
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Rocha Pinto, Luanda, Angola</td>
		<td>4</td>
		<td>4</td>
	</tr>
	<tr>
