...
The `public contributions` and `private contributions` by users in Angola on `2024/3/12 6:24 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/1999GersonMayamba">
				<img src="https://avatars.githubusercontent.com/u/57480551?s=72&u=5ec72cf0104b9b1defa0fa642c8b88ace55aad59&v=4" width="24" alt="Avatar of 1999GersonMayamba"> 1999GersonMayamba
			</a><br/>
			Gerson Mayamba
		</td>
		<td>No Company</td>
