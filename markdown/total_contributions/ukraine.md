...
The `public contributions` and `private contributions` by users in Ukraine on `2023/11/28 10:25 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
