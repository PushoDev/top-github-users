...
The `public contributions` and `private contributions` by users in Ukraine on `2023/12/22 9:22 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
