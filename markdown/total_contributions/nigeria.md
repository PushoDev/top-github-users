...
The `public contributions` and `private contributions` by users in Nigeria on `2023/12/30 1:23 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
