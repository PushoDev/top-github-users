...
The `public contributions` and `private contributions` by users in Nigeria on `2024/4/1 3:10 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
