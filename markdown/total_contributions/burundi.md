...
The `public contributions` and `private contributions` by users in Burundi on `2023/12/29 1:37 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
...
<table>
	...
	<tr>
		<td>195</td>
		<td>
			<a href="https://github.com/wiepovi">
				<img src="https://avatars.githubusercontent.com/u/155049514?s=72&v=4" width="24" alt="Avatar of wiepovi"> wiepovi
			</a><br/>
			Bennie
		</td>
		<td>No Company</td>
